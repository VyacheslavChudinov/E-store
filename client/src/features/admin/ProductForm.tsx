    ...
    <Box component={Paper} sx={{ p: 4 }}>
      ...
      <Grid container spacing={3}>
        <Grid item xs={12} sm={12}>
          <StoreFormInput control={control} name="name" label="Product name" />
        </Grid>
        ...
        <Grid item xs={12} sm={6}>
          <StoreFormInput control={control} name="price" label="Price" />
        </Grid>
        <Grid item xs={12} sm={6}>
          <StoreFormInput
            control={control}
        ...
        <Grid item xs={12}>
          <StoreFormInput control={control} name="pictureUrl" label="Image" />
        </Grid>
      </Grid>
