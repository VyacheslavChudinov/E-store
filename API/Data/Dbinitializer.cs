...
public static class Dbinitializer
{
    public static async Task InitializeAsync(StoreContext context, UserManager<User> userManager)
    {
        if (!userManager.Users.Any())
        {
            ...
            if (userCreate.Succeeded) await userManager.AddToRoleAsync(user, "Member");
            ...
            if (adminUserCreate.Succeeded) await userManager.AddToRolesAsync(adminUser, new[] { "Admin", "Member" });
        }
