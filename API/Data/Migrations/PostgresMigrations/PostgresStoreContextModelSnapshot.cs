...
{
    [DbContext(typeof(PostgresStoreContext))]
    partial class PostgresStoreContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.OrderAggregator.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("API.Entities.OrderAggregator.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("API.Entities.OrderAggregator.Order", b =>
                {
                    b.OwnsOne("API.Entities.OrderAggregator.ShippingAddress", "ShippingAddress", b1 =>
                        {
            ...
            modelBuilder.Entity("API.Entities.OrderAggregator.OrderItem", b =>
                {
                    b.HasOne("API.Entities.OrderAggregator.Order", null)
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId");
