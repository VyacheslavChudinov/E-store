...
public class AccountController : BaseApiController
{
    ...
    public async Task<ActionResult> Register(RegisterDto userRegisterInfo)
    {
        ...
        {
            foreach (var error in createUserResponse.Errors) ModelState.AddModelError(error.Code, error.Description);
    ...
    public async Task<UserDto> GetCurrentUser()
    {
        ...
        if (userBasket is null) Response.Cookies.Delete(BasketService.BuyerIdCookieKey);
